...
function preload(){
  ...
  carImg2 = loadImage("images/police1.png");
  carImg3 = loadImage("images/car1.png");
  carImg4 = loadImage("images/c2.png");
  carImg5 = loadImage("images/f2.png");
...
background("white");
  ...
  textSize(40)
  fill("red")
  text("press the space key to start the game",650,player.y-500);
  if(gameState === 0){
    player.velocityY = 0
...
if(gameState===3){
  ...
  fill("red")
  textSize(30);
  text("HELL YEAH YOU WON!!!",190,player.y-200);
    ...
    player.x = 750
     ...
     if(gameState===2){
      carsGroup.velocityYEach = 0
        ...
        textSize(30)
        fill("red")
        text("OOPS! you lost",650,player.y-200)
        fill("red");
        textSize(30);
        text("Your Score: "+ score,650,player.y-50);
